...
class WorkerType(str, Enum):
    ...
    def to_import_path(self) -> str:
        ...
        Note:
            ...
            Pluggable workers are loaded from pluggable_worker folder.
        """
        # Check if this is a pluggable worker
    ...
    def is_pluggable(self) -> bool:
        ...
        Returns:
            bool: True if pluggable worker, False otherwise

        Note:
            OSS has no pluggable workers. Cloud imports this base
            and extends with pluggable worker logic.
        """
        # Base OSS version - no pluggable workers
        return False
