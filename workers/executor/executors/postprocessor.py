"""Webhook postprocessor for structured output.

Copied from prompt-service/.../helpers/postprocessor.py — already Flask-free.
"""
...
def postprocess_data(
    ...
    Returns:
        tuple: (postprocessed_data, updated_highlight_data)
    """
