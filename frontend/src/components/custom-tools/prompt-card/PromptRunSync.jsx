...
import usePromptRunSync from "../../../hooks/usePromptRunSync";
...
function PromptRunSync() {
  ...
  const { runPrompt, syncPromptRunApisAndStatus } = usePromptRunSync();
