...
class SPSPrompt(BaseModel):
    ...
    tool_id = models.ForeignKey(SPSProject, on_delete=models.CASCADE, related_name="prompts")
    prompt_key = models.CharField(db_comment="Field to store prompt key", max_length=255, editable=True)
    ...
    class Meta:
        db_table = 'sps_prompt'
        constraints = [
            models.UniqueConstraint(fields=['tool_id', 'prompt_key'], name='unique_prompt_key_per_project')
        ]
