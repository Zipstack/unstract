...
class PromptStudioIndexHelper:
    ...
    @staticmethod
    def handle_index_manager(prompt_document_id: str, is_summary: bool, profile_manager: ProfileManager, doc_id: str):
        ...
        if index_manager:
            result: IndexManager = IndexManager.objects.filter(index_manager_id=index_manager.index_manager_id).update(**args)
        else:
