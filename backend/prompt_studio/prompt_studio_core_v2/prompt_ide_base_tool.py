...
from unstract.sdk1.file_storage.constants import EnvHelper as Sdk1EnvHelper
from unstract.sdk1.file_storage.constants import StorageType as Sdk1StorageType
from unstract.sdk1.tool.stream import StreamMixin as Sdk1StreamMixin
...
if FeatureFlagHelper.check_flag_status('sdk_v1'):
    class PromptIdeBaseTool(Sdk1StreamMixin):
        def __init__(self, log_level: Sdk1Loglevel = Sdk1Loglevel.INFO, org_id: str = "") -> None:
            """Args:
            ...
            self.org_id = org_id
            self.workflow_filestorage = Sdk1EnvHelper.get_storage(
