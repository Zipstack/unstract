...
class PromptStudioRegistryHelper:
    ...
    def frame_export_json(
        ...
        for prompt in prompts:
            ...
            output[JsonSchemaKey.ENABLE_POSTPROCESSING_WEBHOOK] = prompt.enable_postprocessing_webhook
            output[JsonSchemaKey.POSTPROCESSING_WEBHOOK_URL] = prompt.postprocessing_webhook_url
