...
class CloneHelper:
    ...
    @staticmethod
    def clone_model_instance(instance, parent=None, null_field=None, new_user=None):
        ...
        unique_fields = CloneHelper.get_unique_fields(ModelClass)  # type: ignore
            ...
            for field in related_fields:
                if field.one_to_many:
                    ...
                    for related_object in related_objects:
                        ...
                        CloneHelper.clone_model_instance(
