...
MAX_WAIT_TIME = get_required_setting("MAX_WAIT_TIME")
POLLING_INTERVAL = get_required_setting("POLLING_INTERVAL")
INDEXING_FLAG_TTL = get_required_setting("INDEXING_FLAG_TTL")
