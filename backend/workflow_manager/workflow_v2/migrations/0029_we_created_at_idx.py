...
date-ordered only within one workflow or pipeline, and the two indexes that are
keyed on created_at are partial, so neither covers the full range. Measurements in
UN-3883.
