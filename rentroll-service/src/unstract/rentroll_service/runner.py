        ...
        try:
            ...
            try:
                ...
                mapping_result_schema = {
                    field: field for field in filtered_mapping.keys()
                }
                ...
                final_result = await self.converter_agent.convert_phase2(
                    json_file_phase1, json_file_final, schema
                )
                with open(final_result, encoding="utf-8") as f:
                    data = json.load(f)
                    logger.info("✓ Extraction completed successfully")
                return data
    ...
    def _get_default_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "unit_type": {
                    "type": "string",
                    "description": "Type of unit (e.g., 1BHK, 2BHK)",
                },
                ...
                "status": {
                    "type": "string",
                    "description": "Occupancy status (e.g., Occupied, Vacant)",
                },
            },
