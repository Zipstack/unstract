...
class RentRollMapper:
    ...
    def _create_agent(self) -> AssistantAgent:
        ...
        system_prompt_path = os.path.join(
            ...
            "../prompts/rentroll_mapper_system.md"
        )
    ...
    async def map_fields(self, extracted_text_file: str, user_json_file: str) -> Dict[str, Any]:
        """
        ...
        user_prompt_path = os.path.join(
            os.path.dirname(__file__), 
            "../prompts/rentroll_mapper_user.md"
        )
    ...
    def _extract_mapping_from_response(self, response: str) -> Optional[Dict[str, Any]]:
